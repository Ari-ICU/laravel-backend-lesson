...
export function PerformanceAnimation() {
  return (
    <div className="relative w-full max-w-4xl h-96 flex items-center justify-around px-10">
      {/* Speed Meter Section */}
        ...
        <div className="relative w-56 h-56 rounded-full border border-white/[0.03] flex items-center justify-center bg-white/[0.01] backdrop-blur-3xl shadow-2xl">
          ...
          <div className="flex flex-col items-center relative z-10">
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <span className="text-[10px] font-black text-white/30 uppercase tracking-[0.3em]">Perfect Score</span>
            </div>
          </div>
        </div>
        <div className="flex flex-col items-center gap-1">
          <span className="text-[10px] font-black text-white/20 uppercase tracking-[0.4em]">Engine Performance</span>
      ...
      <div className="flex flex-col gap-6">
        ...
        >
          <div className="w-14 h-14 rounded-2xl bg-rose-500/10 border border-rose-500/20 flex items-center justify-center shrink-0">
            <Clock className="w-7 h-7 text-rose-400 opacity-40 group-hover:opacity-100 transition-opacity" />
          </div>
          <div>
            <p className="text-[10px] font-black text-white/20 uppercase tracking-widest mb-1">Standard Latency</p>
            <p className="text-3xl font-black text-white/40 group-hover:text-white/60 transition-colors">2.4s</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div>
            <p className="text-[10px] font-black text-primary uppercase tracking-widest mb-1">Expert Optimization</p>
            <div className="flex items-center gap-3">
              <p className="text-3xl font-black text-white">42ms</p>
              <div className="px-2 py-0.5 rounded-md bg-emerald-500/10 border border-emerald-500/20 text-[9px] font-black text-emerald-400">
                -98%
              </div>
            </div>
          </div>
